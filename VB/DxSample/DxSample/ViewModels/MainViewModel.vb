...
Namespace DxSample.ViewModels
    ...
    Public Class MainViewModel
        ...
        Public Sub New()
            Tasks = New ObservableCollection(Of Task)() From {New Task() With {.Title = "Read War and Peace", .Description = "This will make me cleverer", .IsComplete = True}, New Task() With {.Title = "Learn DevExress", .Description = "This will open a lot of possibilities", .IsComplete = False}, New Task() With {.Title = "Become rich", .Description = "Just for fun", .IsComplete = False}, New Task() With {.Title = "Write a book", .Description = "This is for my soul", .IsComplete = False}}
        End Sub
